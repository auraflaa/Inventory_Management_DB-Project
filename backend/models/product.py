...
class Product(db.Model):
    ...
    CompanyID = db.Column(db.Integer, db.ForeignKey('Companies.CompanyID', ondelete='CASCADE'), nullable=False)
    
    # No need to define the relationship here since it's handled by the backref in Company model
